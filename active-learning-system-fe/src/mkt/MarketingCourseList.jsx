...
const savedRole = localStorage.getItem('role');
    ...
    if (savedRole !== 'Marketer' && savedRole !== 'Manager') {
              ...
              {courses.map((course) => (
                <div key={course.courseId} className="course-card-marketing">
                  ...
                  <div className="course-card-body">
                    ...
                    <div style={{ color: '#059669', fontWeight: 600, margin: '6px 0 2px 0', fontSize: 16 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          style={{ width: '100%', padding: 10, borderRadius: 8, border: '1px solid #e5e7eb', marginTop: 4, background: '#fff' }}
                        />
